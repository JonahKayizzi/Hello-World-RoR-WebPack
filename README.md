...
Clone this repository to your desired folder:
  ...
  git clone https://github.com/JonahKayizzi/Hello-World-RoR-WebPack.git
...
Feel free to check the [issues page](https://github.com/JonahKayizzi/Hello-World-RoR-WebPack/issues).
